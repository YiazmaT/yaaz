...
import {PaymentMethodFiltersProps} from "./types";

export function PaymentMethodFiltersComponent(props: PaymentMethodFiltersProps) {
  ...
  return (
    <FilterDrawer
      ...
      onApply={handleApply}
      showActionButtons
      translationPrefix="finance.paymentMethod.filters"
    >
      <FormControlLabel
        control={<Switch checked={showInactives} onChange={(e) => setShowInactives(e.target.checked)} />}
        label={translate("finance.paymentMethod.filters.showInactives")}
      />
    </FilterDrawer>
  );
}
