...
import {BankAccountsFiltersProps} from "./types";

export function BankAccountsFiltersComponent(props: BankAccountsFiltersProps) {
  ...
  return (
    <FilterDrawer
      ...
      onApply={handleApply}
      showActionButtons
      translationPrefix="finance.bank.filters"
    >
      <FormControlLabel
